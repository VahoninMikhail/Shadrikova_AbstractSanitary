...
namespace AbstractSanitaryRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IPlumberService, PlumberServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IItemService, ItemServiceBD>(new HierarchicalLifetimeManager());
